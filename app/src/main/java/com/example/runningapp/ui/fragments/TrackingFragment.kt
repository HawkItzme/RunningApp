...
class TrackingFragment : Fragment(R.layout.fragment_tracking) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            val cancellTrackingDialog = parentFragmentManager.findFragmentByTag(
                CANCEL_TRACKING_DIALOG_TAG) as CancellTrackingDialog?
            cancellTrackingDialog?.setYesListener {
                stopRun()
            }
        }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            R.id.miCancelTracking -> {
                showCancelTrackingDialos()
            }
        }
        return super.onOptionsItemSelected(item)
    }

    private fun showCancelTrackingDialos(){
        CancellTrackingDialog().apply {
            setYesListener {
                stopRun()
            }
